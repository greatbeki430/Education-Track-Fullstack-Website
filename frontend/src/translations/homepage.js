...
export const translations = {
  en: {
    ...
    features: {
      ...
      subtitle: "A complete solution for modern education management",
      items: [
        {
          icon: "📝",
          title: "Digital Gradebook",
        ...
        },
        {
          ...
          description:
            "Generate exam questions from any document automatically",
        },
        {
          icon: "📢",
    ...
    howItWorks: {
      ...
      title: "How EduTrack Ultimate Works",
      ...
      steps: [
        {
          ...
          title: "Admin Setup",
          description:
            "School administrator sets up teachers, students, and classes in minutes",
        },
        {
          number: "2",
          icon: "👨‍🏫",
          ...
          description:
            "Teachers manage grades, attendance, and create online exams easily",
        },
        {
          number: "3",
          icon: "🎓",
          ...
          description:
            "Students view grades, take exams, and stay informed via student portal",
        },
      ],
    },
    // Testimonials
    testimonials: {
      ...
      subtitle: "See what teachers and administrators are saying",
      items: [
        {
    ...
    cta: {
      ...
      subtitle:
        "Join Meskerem Secondary School in embracing digital education management",
      button: "Login to Dashboard",
    },
    // Footer
    footer: {
      school: "Meskerem Secondary School - Communities",
      address: "Addis Ababa, Ethiopia",
      copyright: "EduTrack Ultimate. All rights reserved.",
    },
    // Buttons
    buttons: {
